...
$re = mysql_query("SELECT * FROM last WHERE id=1");
...
<p><form method="get" action="img.php"><input type="text" value="<?php echo $id; ?>" name="qr" hidden></form>
<?php 
$host= gethostname();
$ip = gethostbyname($host);
$web="http://".$ip."/killhouse/killer.php?qr=".$id;?>
	
	<img id="uploadPreview" src="<?php echo "images/img/".$img; ?>" style="width: 80px; height: 80px;" hidden />
	<img id="uploadPrev" src="<?php echo 'php/qr_img.php?d='.$web ?>" style="width: 80px; height: 80px;" hidden></p>
...
co.font='16px Arial'
co.fillStyle='#000000'
co.fillText(des,25,225)


youphot=document.getElementById('uploadPreview')
co.drawImage(youphot,180,110,100,100)
youpho=document.getElementById('uploadPrev')
co.drawImage(youpho,20,110,100,100)
